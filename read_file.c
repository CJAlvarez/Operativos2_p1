...
void fat_read_file(FILE * in,unsigned int fat_start,unsigned int data_start,unsigned int cluster_size,unsigned int cluster,unsigned int file_size) {
...
int main(int argc, char *argv[]) {
    ...
    fat_read_file(in, fat_start, data_start, bs.sectors_per_cluster * 
